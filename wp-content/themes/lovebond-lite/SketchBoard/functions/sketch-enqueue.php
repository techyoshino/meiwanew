...
function lovebond_lite_theme_stylesheet()
{
	...
	// ADD YOSHINO
	wp_enqueue_script('Yjquery',get_template_directory_uri().'/js/jquery.min.js',array('jquery'),'3.5.1',true );


	// ADD YOSHINO
	wp_enqueue_script('Ybgswitcher',get_template_directory_uri().'/js/jquery.bgswitcher.js',array('jquery'),'1.0',true );

	// ADD YOSHINO
	wp_enqueue_script('Yjquery-easing',get_template_directory_uri().'/js/jquery.easing.min.js',array('jquery'),'1.0',true );

	// ADD YOSHINO
	wp_enqueue_script('Ynicescroll',get_template_directory_uri().'/js/jquery.nicescroll.min.js',array('jquery'),'1.0',true );
	...
	// wp_enqueue_script('bgswitcher',get_template_directory_uri().'/js/jquery.bgswitcher.js',array('jquery'),'1.0',true );

	// wp_enqueue_script('jquery-easing',get_template_directory_uri().'/js/jquery.easing.min.js',array('jquery'),'1.0',true );

	// wp_enqueue_script('nicescroll',get_template_directory_uri().'/js/jquery.nicescroll.min.js',array('jquery'),'1.0',true );

	// wp_enqueue_script('common',get_template_directory_uri().'/js/common.min.js',array('jquery'),'1.0',true );
